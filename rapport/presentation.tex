...
\begin{document}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Mouvement en y:\\
      \pause \includegraphics[width=0.8\textwidth]{bifYG981W0.png}
    \end{itemize}
  \end{itemize}
  \end{frame}
  ...
  \begin{itemize}
    \item Trois ``cycles'' dont deux de longueur indépendante en y
    \begin{itemize}
      \item Infinité d'états échantillonables \( \Rightarrow \)
      \item Mouvement formé d'une suite de ces trois cycles
    \end{itemize}
  \end{itemize}
  \end{frame}
