...
\begin{document}
  ...
  \begin{itemize}
    ...
    \end{itemize}
  \end{itemize}
  \pause \includegraphics[width=0.79\textwidth]{bifYG981W0.png}
  \end{frame}
  ...
  \begin{itemize}
    ...
    \end{itemize}
  \end{itemize}
  \pause \includegraphics[width=0.9\textwidth]{bifXG981WTrans.png}
  \end{frame}
  ...
  \end{itemize}
  \begin{center}
  {\rmfamily{\scshape Merci de votre attention}}
  \end{center}
  \end{frame}
